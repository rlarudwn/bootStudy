...
public interface MeterialDAO extends JpaRepository<MeterialEntity, Integer>{
	@Query(value = "SELECT mno, name, poster FROM meterial WHERE poster != 'https://t3.ftcdn.net/jpg/04/84/88/76/360_F_484887682_Mx57wpHG4lKrPAG0y7Q8Q7bJ952J3TTO.jpg' AND name LIKE CONCAT('%',:fd , '%') ORDER BY name ASC LIMIT :start, 12", nativeQuery=true)
